...
class StateResponse(BaseModel):
    state: ObservationResponse = Field(..., description="Current environment state.")
...
class ResetResponse(BaseModel):
    ...
    @property
    def difficulty(self) -> ScenarioName:
        return self.state.difficulty_profile.difficulty
...
class StepResponse(BaseModel):
    state: ObservationResponse = Field(..., description="Environment state after the step is executed.")
